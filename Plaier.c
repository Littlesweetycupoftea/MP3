...
switch (sign) {
    ...
    case '2':
    printf("Playing: Ringo Starr - Were On The Road Again\n");
    mciSendString("play YourMusic/Ringo_Starr_-_Were_On_The_Road_Again.mp3", NULL, 0, NULL);
    break;
    ...
    case '7':
    printf("Playing: P!ATD - Old Fashioned\n");
    mciSendString("play YourMusic/P!ATD_-_Old_Fashioned.mp3", NULL, 0, NULL);
    break;
...
mciSendString("pause YourMusic/Ringo_Starr_-_Were_On_The_Road_Again.mp3", NULL, 0, NULL);
...
mciSendString("pause YourMusic/P!ATD_-_Old_Fashioned.mp3", NULL, 0, NULL);
